# XÂY DỰNG HỆ THỐNG QUẢN LÝ TÀI SẢN THIẾT BỊ
...
- [Thiết kế giao diện người dùng](docs/05-UI-Design.md)
...
| `AMS_Insert_Data.sql` | Thêm dữ liệu test |
| `AMS_Queries_Reports.sql` | Truy vấn phục vụ báo cáo |
